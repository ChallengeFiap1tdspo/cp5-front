...
export default function Login() {
  ...
  // ✅ forma correta de focar no campo usando setFocus
  useEffect(() => {
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8">
        <header className="mb-6 text-center">
          <div className="mx-auto w-16 h-16 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-xl mb-3"></div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`flex h-10 items-center justify-center gap-2 rounded-lg px-4 py-2 text-white shadow-sm transition disabled:opacity-60 bg-gradient-to-r from-blue-600 to-indigo-600 ${
